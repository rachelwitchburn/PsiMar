...
Revision ID: df4eda0b3741
Revises: 
Create Date: 2025-06-05 02:32:07.276681
...
def upgrade() -> None:
    ...
    sa.Column('last_attempt', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    ...
    sa.Column('payment_method', sa.Enum('card', 'transfer', 'cash', name='paymentmethodenum'), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
