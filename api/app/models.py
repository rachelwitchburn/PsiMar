...
class Psicologo(Base):
    ...
    disponibilidades = relationship("Disponibilidade", back_populates="psicologo")
...
class Disponibilidade(Base):
    ...
    hora_inicio = Column(String, nullable=False)  # Pode usar Time se preferir
...
class Agendamento(Base):
    ...
    paciente_id = Column(Integer, ForeignKey("usuario.id"))  # Corrigido de "usuarios.id" para "usuario.id"ilidade.id"))

    paciente = relationship("Usuario", back_populates="agendamentos")
