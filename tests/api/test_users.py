...
def test_register_user_invalid_user_type(client, unique_email):
    response = client.post("/users/", json={
        "first_name": "Teste",
        "last_name": "Invalido",
        "email": unique_email,
...
def test_create_professional_and_check_type(client, insert_access_code, unique_email,unique_access_code):
    email = unique_email
...
def test_register_professional_user(client, insert_access_code, unique_email,unique_access_code):
    email = unique_email
    insert_access_code(unique_access_code)
...
def test_create_professional_without_access_code(client, unique_email):
    response = client.post("/users/", json={
...
def test_full_flow_register_login_appointment_list(client, login_test_user, insert_access_code, unique_email, unique_access_code):
    code = unique_access_code
    insert_access_code(code)

    email_paciente = "patient" + unique_email
    email_profissional = "prof" + unique_email
