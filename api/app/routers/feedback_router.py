...
from api.app.crud import feedback_service as feedback_crud
...
def list_feedback_by_professional(
    ...
    feedbacks = feedback_crud.get_feedback_by_professional_id(db=db, professional_id=professional_id)
    if not feedbacks:
