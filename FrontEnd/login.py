                    ...
                    ft.Container(
                        content=ft.Column(
                            [
                                ...
                                ft.Row(
                                    [
                                        ft.ElevatedButton("Login", on_click=login_action, color="white", width=140, style=ft.ButtonStyle(
                                        ...
                                        ft.ElevatedButton("Registrar", on_click=lambda e: page.go("/register"), width=140, style=ft.ButtonStyle(
                                            shape=ft.RoundedRectangleBorder(radius=5),  
                                            elevation=5, 
                                            overlay_color="rgba(255, 255, 255, 0.2)",
                                            bgcolor="#212121",
